...
if (NOT EXISTS "${INFOPARSE_DIR}")
    ...
    if (WIN32)
        execute_process(
                COMMAND cmd /c "${GIT_EXEC}" clone https://github.com/isbodand/infoparse ${INFOPARSE_DIR}
                WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
        )
    else ()
        execute_process(
                COMMAND "${GIT_EXEC}" clone https://github.com/isbodand/infoparse ${INFOPARSE_DIR}
                WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
        )
    endif ()
