...
namespace LibCqt {
    ...
    namespace _Impl {
      ...
      //&!off
        ...
        (Ptr<RType>) _archetype_cast(CRf<Raw<InType>> array) {
      ...
      //&!off
        ...
        (Ptr<RType>) _archetype_cast(CRf<Raw<InType>> scalar) {
          auto ptr = mkPtr<RType>();
      ...
      //&!off
        ...
        (Ptr<RType>) _archetype_cast(CRf<Raw<InType>> hash) {
          ...
          for (auto&&[_, val] : hash->getMap()) {
              ...
              case archScalar: // Every array can store any scalar
                  ...
                  case scalarAnyScalar:
                      ptr->template makeCellOfType<ScalarArchetype>(val);
                      break;
                  case scalarCharacterScalar:
                      ptr->template makeCellOfType<CharacterScalarType>(val);
                      break;
                  case scalarTrueScalar:
                      ptr->template makeCellOfType<TrueScalarType>(val);
                      break;
                  }
                  break;
              case archArray:
                  ...
                  case arrayFlatArray:
                      if constexpr (absorbs<RT, ArrayArchetype>()) {
                          ...
                          ptr->template makeCellOfType<TrueScalarType>(::LibCqt::archetype_cast<TrueScalarType>(val));
                      }
                      break;
...
constexpr bool LibCqt::_Impl::absorbs() {
    return std::is_assignable_v<Ref<T>, U>();
}
